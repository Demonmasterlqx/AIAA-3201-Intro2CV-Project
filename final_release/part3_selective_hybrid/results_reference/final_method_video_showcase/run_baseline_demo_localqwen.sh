...
OUT="results/final_method_video_showcase/baseline_localqwen_blip2_gained5_v1"
mkdir -p "$OUT"

python -u -m ascent.run \
  --config-name=eval_ascent_hm3d.yaml \
  "habitat.dataset.data_path='/data/home/sim6g/code/aiaa3201_cv_project/ascent_opt_localqwen_100ep/data/datasets/objectnav/hm3d/final_demo_gained5_indexed/v1/{split}/{split}.json.gz'" \
  "habitat.dataset.scenes_dir=/data/home/sim6g/code/aiaa3201_cv_project/ascent/ascent/data/scene_datasets" \
  "habitat.dataset.content_scenes=[q3zU7Yy5E5s,QaLdnwvtxbs,svBbv1Pavdk,wcojb4TFT35]" \
