...
python -u -m ascent.run \
  ...
  "habitat.dataset.data_path='/data/home/sim6g/code/aiaa3201_cv_project/ascent_opt_localqwen_100ep/data/datasets/objectnav/hm3d/localqwen_100ep_fixed/v2/{split}/{split}.json.gz'" \
  ...
  habitat_baselines.video_dir="results/localqwen_100ep/final100_baseline_blip2_v1/videos" \
