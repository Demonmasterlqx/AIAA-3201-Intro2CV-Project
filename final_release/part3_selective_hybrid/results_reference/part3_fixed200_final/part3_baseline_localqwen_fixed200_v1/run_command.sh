...
python -u -m ascent.run \
  ...
  habitat_baselines.video_dir="/data/home/sim6g/code/aiaa3201_cv_project/ascent_opt_localqwen_100ep/results/part3_fixed200_final/part3_baseline_localqwen_fixed200_v1/videos" \
