...
| --- | ---: | ---: | ---: | ---: |
| Plan A Dense | 10 | 10.00% | 8.33% | 23.03% |
| Plan B Frontier | 10 | 20.00% | 15.70% | 29.71% |
...
Plan A Dense:
- never_saw_target_did_not_travel_stairs_feasible: 4
- never_saw_target_did_not_travel_stairs_likely_infeasible: 3
- false_positive: 2
- did_not_fail: 1

Plan B Frontier:
- never_saw_target_did_not_travel_stairs_likely_infeasible: 3
- never_saw_target_did_not_travel_stairs_feasible: 3
- false_positive: 2
- did_not_fail: 2
...
- Per-episode comparison table: `artifacts_budget80_ep10/episode_comparison.csv`
- Representative dense trajectory video: `artifacts_budget80_ep10/videos/plan_a_dense_representative.mp4`
- Representative frontier trajectory video: `artifacts_budget80_ep10/videos/plan_b_frontier_representative.mp4`
- Dense top-down semantic map figure: `artifacts_budget80_ep10/maps/plan_a_dense_maps.png`
- Frontier top-down semantic map figure: `artifacts_budget80_ep10/maps/plan_b_frontier_maps.png`
