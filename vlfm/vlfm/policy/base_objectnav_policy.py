...
class BaseObjectNavPolicy(BasePolicy):
    ...
    def _pre_step(self, observations: "TensorDict", masks: Tensor) -> None:
        ...
        try:
            ...
            self._termination_hint = "mapping_issue"
            raise StopIteration
        self._policy_info = {}
    ...
    def _get_policy_info(self, detections: ObjectDetections) -> Dict[str, Any]:
        ...
        policy_info = {
            ...
            "termination_hint": self._termination_hint,
...
class VLFMConfig:
    ...
    non_coco_threshold: float = 0.4
    agent_radius: float = 0.18
    dense_point_radius: float = 0.75
    dense_min_value: float = -1.0
    dense_min_distance: float = 0.75
    dense_max_candidates: int = 25
    adaptive_semantic_threshold: float = 0.2
    adaptive_score_ema_alpha: float = 0.6
    adaptive_score_history_length: int = 5
    adaptive_min_confident_fraction: float = 0.6
    adaptive_max_score_std: float = 0.15
    adaptive_frontier_min_distance: float = 0.75
    collab_agent_id: str = ""
    collab_shared_memory_path: str = ""
    collab_claim_cell_size_m: float = 2.0
    collab_claim_radius_m: float = 1.5
    collab_candidate_score_margin: float = 0.02
    collab_peer_success_stop: bool = True
    collab_initial_sector_bias: float = 0.0
    collab_shared_update_every_n_steps: int = 1
