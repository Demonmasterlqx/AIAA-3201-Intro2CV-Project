...
_CONFIG.PLAN_A = CN()
_CONFIG.PLAN_A.RUN_NAME = ""
_CONFIG.PLAN_A.DATASET = "hm3d"
_CONFIG.PLAN_A.SPLIT = "val"
_CONFIG.PLAN_A.OUTPUT_ROOT = "outputs/plan_a"
_CONFIG.PLAN_A.SEED = 1234
_CONFIG.PLAN_A.MAX_EPISODES = -1
_CONFIG.PLAN_A.SHARD_INDEX = 0
_CONFIG.PLAN_A.NUM_SHARDS = 1
_CONFIG.PLAN_A.CLIP_MODEL = "ViT-B/32"
_CONFIG.PLAN_A.CLIP_INPUT_SIZE = 224
_CONFIG.PLAN_A.PATCH_GRID = 7
_CONFIG.PLAN_A.PATCH_SIZE = 32
_CONFIG.PLAN_A.PROMPT_TEMPLATE = "a photo of a {cat}"
_CONFIG.PLAN_A.MIN_DEPTH_M = 0.1
_CONFIG.PLAN_A.MAX_DEPTH_M = 10.0
_CONFIG.PLAN_A.SEMANTIC_THRESHOLD = 0.20
_CONFIG.PLAN_A.STOP_SIMILARITY_THRESHOLD = 0.18
_CONFIG.PLAN_A.STOP_DEPTH_M = 1.40
_CONFIG.PLAN_A.USE_SUCCESS_DISTANCE_STOP = True
_CONFIG.PLAN_A.LOCAL_GOAL_RADIUS = 0.10
_CONFIG.PLAN_A.MIN_SUBGOAL_DISTANCE_M = 0.35
_CONFIG.PLAN_A.REPLAN_INTERVAL = 50
_CONFIG.PLAN_A.TOP_K_SEMANTIC_CANDIDATES = 128
_CONFIG.PLAN_A.FRONTIER_CANDIDATE_LIMIT = 1024
_CONFIG.PLAN_A.FRONTIER_BOOTSTRAP_STEPS = 8
_CONFIG.PLAN_A.FRONTIER_RECOVERY_STEPS = 10
_CONFIG.PLAN_A.MIN_SEMANTIC_CELL_COUNT = 1
_CONFIG.PLAN_A.SEMANTIC_MARGIN = 0.0
_CONFIG.PLAN_A.FRONTIER_UNKNOWN_RADIUS = 12
_CONFIG.PLAN_A.FRONTIER_DISTANCE_PENALTY = 0.15
_CONFIG.PLAN_A.RECOVERY_ACTIONS = [2, 1, 1, 3, 1, 1]
_CONFIG.PLAN_A.RECOVERY_COOLDOWN_STEPS = 12
_CONFIG.PLAN_A.ROTATION_STUCK_WINDOW = 10
_CONFIG.PLAN_A.ROTATION_STUCK_TURNS = 8
_CONFIG.PLAN_A.FAILED_GOAL_COOLDOWN = 20
_CONFIG.PLAN_A.SUPPRESSION_RADIUS = 6
_CONFIG.PLAN_A.STUCK_WINDOW = 20
_CONFIG.PLAN_A.STUCK_DISTANCE_M = 0.20
_CONFIG.PLAN_A.SMOOTHING_KERNEL = 3
_CONFIG.PLAN_A.PROJECTION_STRIDE = 8
_CONFIG.PLAN_A.WRITE_VIDEOS = True
_CONFIG.PLAN_A.SAVE_DEBUG_IMAGES = True
_CONFIG.PLAN_A.VIDEO_FPS = 10
_CONFIG.PLAN_A.EGO_SENSOR = "rgb"
_CONFIG.PLAN_A.DEPTH_SENSOR = "depth"
