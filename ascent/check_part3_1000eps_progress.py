...
queue = base / "part3_1000eps_queue_v2.log"
logs = {
    "single": base / "ascent/results/baseline_compare_single/20260502_single_1000eps_rerun_v2/run.log",
    "objectpatch": base
...
for line in out.splitlines():
    if "part3_1000eps_rerun_v2" in line or "qwenvl_14187" in line:
        print(line)
