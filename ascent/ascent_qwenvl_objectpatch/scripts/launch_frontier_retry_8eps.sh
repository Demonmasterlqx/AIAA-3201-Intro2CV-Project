...
SESSION=qwenvl_objectpatch_retry8
RESULT_DIR=results/baseline_compare_single/qwenvl_objectpatch_frontier_retry_8eps_v1
...
case "$RESULT_DIR" in
  results/baseline_compare_single/qwenvl_objectpatch_frontier_retry_8eps_v1)
    rm -rf "$RESULT_DIR"
    ;;
  *)
...
git show --stat --oneline -3 > "$RESULT_DIR/recent_commits.txt"
