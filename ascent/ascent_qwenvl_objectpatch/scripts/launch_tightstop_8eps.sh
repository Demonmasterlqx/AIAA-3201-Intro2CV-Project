...
SESSION=qwenvl_objectpatch_tightstop8
RESULT_DIR=results/baseline_compare_single/qwenvl_objectpatch_tight_stop_8eps_v1
...
case "$RESULT_DIR" in
  results/baseline_compare_single/qwenvl_objectpatch_tight_stop_8eps_v1)
    rm -rf "$RESULT_DIR"
    ;;
  *)
