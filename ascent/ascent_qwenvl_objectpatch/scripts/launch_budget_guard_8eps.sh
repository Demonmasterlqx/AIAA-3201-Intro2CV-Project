...
SESSION=qwenvl_objectpatch_budgetguard8
RESULT_DIR=results/baseline_compare_single/qwenvl_objectpatch_budget_guard_8eps_v1
...
case "$RESULT_DIR" in
  results/baseline_compare_single/qwenvl_objectpatch_budget_guard_8eps_v1)
    rm -rf "$RESULT_DIR"
    ;;
  *)
...
git show --stat --oneline -2 > "$RESULT_DIR/recent_commits.txt"
