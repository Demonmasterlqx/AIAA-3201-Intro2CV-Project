...
SESSION=qwenvl_objectpatch_stair220_8
RESULT_DIR=results/baseline_compare_single/qwenvl_objectpatch_early_stair220_8eps_v1
...
case "$RESULT_DIR" in
  results/baseline_compare_single/qwenvl_objectpatch_early_stair220_8eps_v1)
    rm -rf "$RESULT_DIR"
    ;;
  *)
...
git show --stat --oneline -7 > "$RESULT_DIR/recent_commits.txt"
