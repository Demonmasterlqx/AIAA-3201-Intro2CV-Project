...
SESSION=qwenvl_objectpatch_earlystair8
RESULT_DIR=results/baseline_compare_single/qwenvl_objectpatch_early_stair_waypoint_8eps_v1
...
case "$RESULT_DIR" in
  results/baseline_compare_single/qwenvl_objectpatch_early_stair_waypoint_8eps_v1)
    rm -rf "$RESULT_DIR"
    ;;
  *)
