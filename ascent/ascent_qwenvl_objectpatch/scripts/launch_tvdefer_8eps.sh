...
SESSION=qwenvl_objectpatch_tvdefer8
RESULT_DIR=results/baseline_compare_single/qwenvl_objectpatch_tv_defer_close_8eps_v1
...
case "$RESULT_DIR" in
  results/baseline_compare_single/qwenvl_objectpatch_tv_defer_close_8eps_v1)
    rm -rf "$RESULT_DIR"
    ;;
  *)
...
git diff HEAD~4..HEAD --stat > "$RESULT_DIR/diff_stat.txt"
