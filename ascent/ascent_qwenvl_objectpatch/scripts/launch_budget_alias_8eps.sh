...
SESSION=qwenvl_objectpatch_budget8
RESULT_DIR=results/baseline_compare_single/qwenvl_objectpatch_budget_alias_8eps_v1
...
case "$RESULT_DIR" in
  results/baseline_compare_single/qwenvl_objectpatch_budget_alias_8eps_v1)
    rm -rf "$RESULT_DIR"
    ;;
  *)
