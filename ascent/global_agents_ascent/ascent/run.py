...
from ascent import g_ascent_access_mgr  # noqa: F401
from ascent import g_ascent_config  # noqa: F401
from ascent import g_ascent_policy  # noqa: F401
from ascent import g_ascent_simulator  # noqa: F401
from ascent import g_ascent_task  # noqa: F401


def _set_default_service_ports() -> None:
    os.environ.setdefault("QWEN2_5_PORT", "14181")
    os.environ.setdefault("BLIP2ITM_PORT", "14182")
    os.environ.setdefault("SAM_PORT", "14183")
    os.environ.setdefault("GROUNDING_DINO_PORT", "14184")
    os.environ.setdefault("RAM_PORT", "14185")
    os.environ.setdefault("DFINE_PORT", "14186")
