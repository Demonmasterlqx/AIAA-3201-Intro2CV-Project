...
export QWEN2_5_VL_PORT=${QWEN2_5_VL_PORT:-$((BASE_PORT + 6))}
export QWEN2_5_VL_MODEL_PATH=${QWEN2_5_VL_MODEL_PATH:-pretrained_weights/Qwen2.5-VL-7B-Instruct}
export QWEN2_5_VL_CUDA_DEVICE=${QWEN2_5_VL_CUDA_DEVICE:-5}
...
tmux send-keys -t ${session_name}:0.6 "export CUDA_VISIBLE_DEVICES=${QWEN2_5_VL_CUDA_DEVICE}; ${ASCENT_PYTHON} -m model_api.qwen25_vl_out --port ${QWEN2_5_VL_PORT} --model-path ${QWEN2_5_VL_MODEL_PATH} --device cuda:0" C-m
