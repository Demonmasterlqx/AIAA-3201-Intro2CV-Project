...
SESSION=qwenvl_objectpatch_stallstop8
RESULT_DIR=results/baseline_compare_single/qwenvl_objectpatch_qwen_approach_stallstop_8eps_v1
...
case "$RESULT_DIR" in
  results/baseline_compare_single/qwenvl_objectpatch_qwen_approach_stallstop_8eps_v1)
    rm -rf "$RESULT_DIR"
    ;;
  *)
